...
First, considering the data collected from Mr. Trash Wheel during 2014 - 2018, after cleaning the data, there exist 285 data collection observations in 14 variables. The cleaning process involved standardizing variable names, identifying and filtering observations for "Monthly totals", rounding sports ball values to the nearest integer, and imputing missing years for the last few observations. After the process, the data includes variables for year, month, date, weight, volume, counts of different types of trash, and approximate amount of homes powered by the electricity generated from Mr. Trash Wheel; per each trash collection observation. During the almost three years of obervation, a total of 934.94 tons and 4439 cubic yards of trash were collected, with an average of 3.28 tons and 15.575 cubic yards collected per observation. Additionally, the largest average contributor per collection to Mr. Trash Wheel's consumption over this time frame, other than cigarette butts (36103.86), was polystyrene trash (2320.832), followed by plastic bottles, chip bags, and grocery bags, (1969.053, 1920.558, 1418.867), respectively. A complete table of summary statistics for the cleaned Mr. Trash Wheel data can be found below (code in the Appendix).
...
|--------|-------------:|---------------------:|-----------------:|------------:|-----------------:|---------------:|--------------:|-----------:|--------------:|---------------:|
| Min    |          0.96|                 7.000|           210.000|      320.000|           1000.00|           2.000|         50.000|     330.000|          0.000|           0.000|
| 1Q     |          2.73|                15.000|           980.000|     1250.000|          12000.00|          12.000|        650.000|    1040.000|          5.000|          30.500|
| Median |          3.33|                15.000|          1930.000|     2250.000|          26000.00|          26.000|       1240.000|    1840.000|          8.000|          50.667|
| Mean   |          3.28|                15.575|          1969.053|     2320.832|          36103.86|          27.982|       1418.867|    1920.558|         12.628|          41.932|
| 3Q     |          3.83|                17.000|          2670.000|     3150.000|          46000.00|          42.000|       2130.000|    2660.000|         18.000|          60.333|
| Max    |          5.62|                20.000|          5960.000|     6540.000|         310000.00|         110.000|       3750.000|    5085.000|         56.000|          93.667|
| Sum    |        934.94|              4439.000|        561180.000|   661437.000|       10289600.00|        7975.000|     404377.000|  547359.000|       3599.000|       11950.667|
...
This problem focuses on the BRFSS data set, loaded from the p8105 github repo. After cleaning and briefly summarizing these data, we will answer the following questions:
